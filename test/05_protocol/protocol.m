...
@interface SubProp : Super <Proto4> { int _i; } @end
@implementation SubProp
@synthesize i;
@end

@interface GetProtocolsIntoRuntime <Proto1, Proto2, Proto3, Proto4, Proto5, Proto6, ProtoEmpty>
{ int _i; }
@end
...
int main()
{
    ...
    protocol = objc_getProtocol("Proto3");
    empty = objc_getProtocol("ProtoEmpty");
    testassert(protocol);
    testassert(empty);
   ...
   //  testassert([empty isKindOf:[Protocol class]]);
    ...
    // original test: Super conforms. SubProp is subclass of Super. Why doesn't it conform ?
...
//     testassert(!desc2.name && !desc2.types);
   ...
   //  free(list);
    ...
    testassert(list[0] == @protocol( Proto1));
    free(list);
    ...
    testassert(list);
    testassert(count == 1);
    testassert(list[0] ==  @protocol(Proto4));
