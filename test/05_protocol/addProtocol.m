...
// needed for mulle-objc runtime to have above registered in runtime for
// lookup
@interface GetProtocolsIntoRuntime < SuperProto, SuperProto2, UnrelatedProto>
@end
@implementation GetProtocolsIntoRuntime 
@end 
...
int main()
{
    ...
    aproto = @protocol(SuperProto);
    aproto = @protocol(SuperProto2);
    ...
    protocol_addProtocol(proto, _mulle_objc_protocol_get_protocolid( proto2));  // fails
    objc_registerProtocol(proto2);
    protocol_addProtocol(proto, _mulle_objc_protocol_get_protocolid( proto2));  // succeeds
...
/*
   // note this order is not required
    testassert(protolist[0] == @protocol(SuperProto)  &&  
               ...
               protolist[2] == _mulle_objc_protocol_get_protocolid(proto2));
    free(protolist);

    testassert(protocol_conformsToProtocol( proto, _mulle_objc_protocol_get_protocolid( proto2)));
...
*/
    ...
    testassert(!protocol_conformsToProtocol( proto2, _mulle_objc_protocol_get_protocolid( proto)));
