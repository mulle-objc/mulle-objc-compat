...
int main()
{
    ...
    ok = class_addMethod([Super class], sel_registerName( "superMethodNew2"), (IMP)fn, NULL);
    testassert(ok);
    ...
    imp = class_replaceMethod([Sub2 class], sel_registerName( "subMethodNew"), (IMP)fn, NULL);
    testassert(imp == NULL);
    ...
    imp = class_replaceMethod([Super class], sel_registerName( "superMethodNew"), (IMP)fn, NULL);
    testassert(imp == NULL);
