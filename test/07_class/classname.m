...
// (nat) buf test thrown out because:
//   a) malloc_size not available
//   b) isa is not part of the object ivar space (its in meta space)
//
int main()
{
...
//    *buf = [Fake class];
    ...
    // (nat) setup obj like above
    testassert(object_setClass(obj, [Fake class]) == [TestRoot class]);
