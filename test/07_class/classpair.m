...
# define align 3
    ...
    */
    ...
    // (nat) I don't understand the comment or what is happening here
    //       specifically why super_initialize is supposed to be 0
    //       but state 1
    //
    ...
    */
    ...
    testassert(ok);
    // (nat) fix wrong type [16^] -> [16^v]
    ok = class_addIvar(cls2, "ptrarray", 16*sizeof(void*), align, "[16^v]");
    testassert(ok);
