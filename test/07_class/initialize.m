...
int main()
{
    ...
    // (nat) I don't understand this test. I would, if Super3 method
    //       was called but the gratuitous class check in +initialize
...
//    testassert(state == 3);
   ...
   // (this doesn't work in mulle-objc and I am not sure if that's something I want 
   //  to support)
